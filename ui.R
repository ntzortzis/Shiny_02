...
shinyUI(
  pageWithSidebar(
    ...
    sidebarPanel(tags$head(tags$style("body {background-color: antiquewhite;}")),
     ...
     p(),
     p(),
     div('This graph is about a credit bank portfolio and the monthly payment performance of the assigned debt to debt collection agencies compared to the performance of the unassigned for the period between 201306 and 201405. The graph shows this performance comaprison. By changing the month and year of the above date, you can see the performance for the corresponding month and year on the chart.'),
     div('--------------------------------------------------------------------------'),
     p(),
